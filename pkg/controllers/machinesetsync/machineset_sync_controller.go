...
func setChangedCAPIMachineSetStatusFields(existingCAPIMachineSet, convertedCAPIMachineSet *clusterv1.MachineSet) {
	...
	util.EnsureCAPIDeprecatedV1Beta1Conditions(existingCAPIMachineSet, convertedCAPIMachineSet)
...
func compareCAPIInfraMachineTemplates(platform configv1.PlatformType, infraMachineTemplate1, infraMachineTemplate2 client.Object) (util.DiffResult, error) {
	...
	diff, err := util.NewDefaultDiffer(diffOpts...).Diff(infraMachineTemplate1, infraMachineTemplate2)
	if err != nil {
...
func compareCAPIMachineSets(capiMachineSet1, capiMachineSet2 *clusterv1.MachineSet) (util.DiffResult, error) {
	diff, err := util.NewDefaultDiffer(
		...
		util.WithIgnoreConditionType(clusterv1.RemediatingCondition),
